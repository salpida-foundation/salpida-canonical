# Salpida Foundation — Canonical Repository (`salpida-canonical`)

> **Canonical public index for Salpida Foundation / SICS**  
> This repository exists to route readers to the **DOI-registered canonical records** of the Salpida Foundation document stack.  
> **GitHub carries no independent interpretive authority. Canonical authority lives only in DOI-registered records on Zenodo / OSF.**
...
- negative definition
- compliance boundary
- future broader opening governance
...
- bridge and public-facing orientation records

For full authoritative records, use the DOI entry points above.

---

## Why This Repository Exists

Modern GitHub repositories are easy to fork, summarize, scrape, paraphrase, and reinterpret.

That is exactly why canonical authority must be fixed elsewhere.

This repository exists to make one thing clear:

**the public GitHub layer is useful for discovery, navigation, and reading order — but not for sovereign interpretation.**

The canonical layer is fixed only in DOI-registered records.

---

## Citation Rule

If you cite, reference, analyze, or derive from this project:

- **cite the DOI-registered record**
- do **not** treat GitHub text alone as final authority
- use the **Concept DOI** when you want the stable entry for all versions
- use the **Version DOI** when you want the exact frozen snapshot
...
- find the canonical DOI entry quickly
- understand which layer is canonical and which is explanatory
...
This repository does not ask to be believed.
